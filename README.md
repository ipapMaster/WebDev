...
17. Современный учебник Java Script: https://learn.javascript.ru/
18. Справочник по JavaScript и JQuery: https://html5book.ru/javascript-jquery/
19. Файл настроек VS Code (**settings.json**), как правило, находится тут: c:\Users\имя пользователя\AppData\Roaming\Code\User
20. Содержимое файла **settings.json** следующее:
```
{
